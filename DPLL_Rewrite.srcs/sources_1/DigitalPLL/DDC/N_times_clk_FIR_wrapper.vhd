...
architecture Behavioral of N_times_clk_FIR_wrapper is
	...
	--attribute MAX_FANOUT : integer; --通过限制高扇出解决时序不同步问题
	--attribute MAX_FANOUT of flag_times_1 : signal is 6;
...
begin
	...
	fir_compiler_minimumphase_N_times_clk_inst : fir_compiler_minimumphase 
		port map (
			aclk               => clk_times_N,
