...
entity N_times_clk_FIR_wrapper_H  is
Generic (
...
architecture Behavioral of N_times_clk_FIR_wrapper_H is

	-- FIR compiler component:_N_times_clk
	component fir_compiler_minimumphase_H IS
		PORT (
			aclk               : IN STD_LOGIC;
...
begin
	...
	fir_compiler_minimumphase_N_times_clk_inst : fir_compiler_minimumphase_H 
		port map (
			aclk               => clk_times_N,
