...
module red_pitaya_ps (
  ...
  output wire  [  4-1: 0] fclk_clk_o         ,
  output wire  [  4-1: 0] fclk_rstn_o        ,
  // XADC
  ...
  output wire  [ 32-1: 0] sys_addr_o         ,  // system read/write address
  output wire  [ 32-1: 0] sys_wdata_o        ,  // system write data
  output wire  [  4-1: 0] sys_sel_o          ,  // system write byte select
  output wire             sys_wen_o          ,  // system write enable
  output wire             sys_ren_o          ,  // system read enable
  input  wire  [ 32-1: 0] sys_rdata_i        ,  // system read data
  input  wire             sys_err_i          ,  // system error indicator
  input  wire             sys_ack_i          ,  // system acknowledge signal
  // AXI masters
  input  wire              axi0_clk_i   ,
//  input  wire             axi1_clk_i   , axi0_clk_i   ,  // global clock
//  input  wire             axi1_rstn_i  , axi0_rstn_i  ,  // global reset
//  input  wire  [ 32-1: 0] axi1_waddr_i , axi0_waddr_i ,  // system write address
//  input  wire  [ 64-1: 0] axi1_wdata_i , axi0_wdata_i ,  // system write data
//  input  wire  [  8-1: 0] axi1_wsel_i  , axi0_wsel_i  ,  // system write byte select
//  input  wire             axi1_wvalid_i, axi0_wvalid_i,  // system write data valid
