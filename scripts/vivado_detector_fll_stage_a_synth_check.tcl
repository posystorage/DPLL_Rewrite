...
set out_dir [file join $repo_root reports vivado_detector_fll_stage_a_synth_check]
...
report_timing_summary -file [file join $out_dir fll_phase_difference_timing_ooc.rpt]
close_project
