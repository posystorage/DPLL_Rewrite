...
read_verilog [file join $repo_root DPLL_Rewrite.srcs sources_1 DigitalPLL DDC cordic_word_serial_adapter.v]
...
read_verilog [file join $repo_root DPLL_Rewrite.srcs sources_1 DigitalPLL DDC dpll_single_clock_core_stage_a.v]
