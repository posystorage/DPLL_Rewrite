...
def check_case(case_index: int, rows: list[dict[str, str]]) -> tuple[list[str], str]:
    ...
    line = (
        ...
        f"{tail_positive}/{len(rows) - tail_start} | {track} | {locked} | {fll_valid_counts[-1]} | {max(magnitudes)} | {result} |"
    )
...
def check_rows(rows: list[dict[str, str]]) -> tuple[list[str], list[str]]:
    ...
    lines = [
        ...
        "",
        "| Case | Center Hz | Input Hz | Center Word | Input Word | High-Side Delta | Rows | Nonzero | Positive | Tail Positive | TRACK | Locked | FLL Valid | Max Mag | Result |",
        "|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---:|---|",
    ]
