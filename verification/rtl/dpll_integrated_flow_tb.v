...
//    assign adc_dds_scaled_16 = adc_dds_scaled_wide[15:0];
    ...
    initial begin
        ...
        bus_write(16'h0065, 32'h08b7_0c79);
        bus_write(16'h0066, 32'h116e_18f1);
        bus_write(16'h0067, 32'h08b7_0c79);
        bus_write(16'h0068, 32'hd1ea_352a);
        bus_write(16'h0069, 32'h10f1_fcb9);
        bus_write(16'h006a, 32'h047e_0a50);
        bus_write(16'h006b, 32'h08fc_14a1);
        bus_write(16'h006c, 32'h047e_0a50);
        bus_write(16'h006d, 32'hb818_4041);
        bus_write(16'h006e, 32'h19df_e901);
